package tree.FindRootOfNAryTree_1506;
...
public class Solution {
    ...
    // same solution as that one with set of children but instead of set we can use int variable
    // and put sum of all nodes as being parent with + and all children with -. So int the end we will get the target root val.
