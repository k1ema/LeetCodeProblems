...
//        assertEquals(Arrays.asList(2, 1), s.largestDivisibleSubset(new int[] {1, 2, 3}));
//        assertEquals(Arrays.asList(8, 4, 2, 1), s.largestDivisibleSubset(new int[] {1, 2, 4, 8}));
//        assertEquals(Arrays.asList(8, 4, 2, 1), s.largestDivisibleSubset(new int[] {1, 2, 3, 4, 5, 6, 8}));
//        assertEquals(Arrays.asList(864, 432, 216, 108, 36, 18, 9, 3, 1),
