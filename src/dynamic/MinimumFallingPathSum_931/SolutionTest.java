...
public class SolutionTest {
    ...
    public void test() {
        ...
        assertEquals(12, s.minFallingPathSum(new int[][] {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}}));
        assertEquals(-27, s.minFallingPathSum(new int[][] {{17, 82}, {1, -44}}));
        assertEquals(-26, s.minFallingPathSum(new int[][] {{51, 24}, {-50, 82}}));
        assertEquals(-1428, s.minFallingPathSum(new int[][] {
